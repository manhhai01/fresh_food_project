        ...
        columnDefs: [{
            ...
            render: function(a, e, t, s) {
                var n = t.invoice_status,
                    l = t.due_date;
                return "<span data-bs-toggle='tooltip' data-bs-html='true' title='<span>" + n + "<br> Balance: " + t.balance + "<br> Due Date: " + l + "</span>'>" + {
