...
// $.get('nav-bar.html', function(content){
//   $("#layout-menu").append($(content))
// }).done(function(){
//     $.get('search-bar.html', function(content){
//         $("#layout-navbar").append($(content))
//     }).done(function(){})
...
$.get('search-bar.html', function(content){
            ...
            function() {
                ...
                window.templateCustomizer ? (t && t.addEventListener("click", function() {
                    ...
                    title: "Light mode",
                    fallbackPlacements: ["bottom"]
                })), s("dark"))) : t.parentElement.remove(), "undefined" != typeof i18next && "undefined" != typeof i18NextHttpBackend && i18next.use(i18NextHttpBackend).init({
                    lng: "en",
                    debug: !1,
                    fallbackLng: "en",
                    backend: {
